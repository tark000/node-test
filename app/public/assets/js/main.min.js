...
var myApp=angular.module("myApp",["ngRoute"]);myApp.config(["$routeProvider","$locationProvider",function(e,t){e.when("/",{templateUrl:"/assets/tmpl/home.html",controller:"HomeController"}).when("/create-note",{templateUrl:"/assets/tmpl/createNote.html",controller:"CreateNoteController"}).otherwise({redirectTo:"/"}),t.html5Mode({enabled:!0,requireBase:!1})}]);
